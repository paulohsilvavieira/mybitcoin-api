...
diag.setLogger(
  ...
  isDev ? DiagLogLevel.INFO : DiagLogLevel.ERROR,
);

const OTEL_GRPC_ENDPOINT =
  process.env.OTEL_EXPORTER_OTLP_ENDPOINT || 'http://localhost:14317';
const OTEL_HTTP_ENDPOINT =
  process.env.OTEL_EXPORTER_OTLP_HTTP_ENDPOINT || 'http://localhost:14318';
